...
public class Circle extends GraphicObject {
	...
	public String toString() {
		...
		return "X: " + this.centerX + "Y: " + this.centerY + "radius: " + this.radius;
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof Circle) {
			Circle x = (Circle) obj;
			return x.radius == this.radius && x.centerX == this.centerX && x.centerY == this.centerY;
	 ...
	 */
	 ...
	 protected Object clone() throws CloneNotSupportedException {
		 Circle x = new Circle();
		 x.centerX = this.centerX;
		 x.centerY = this.centerY;
